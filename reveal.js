...
! function(e, t) {
    ...
    var Sn = un && +un,
        ...
        Kn = function(e) {
            ...
            return function(l, c, u, d) {
                for (var h, f, v = _n(l), p = Bn(v), g = Un(c, u, 3), m = qn(p.length), y = 0, b = d || Wn, w = t ? b(l, m) : n || o ? b(l, 0) : void 0; m > y; y++)
    ...
    var is, rs, as, os = nt,
        ...
        vs = ke("IE_PROTO"),
        ps = Object.prototype,
        gs = fs ? Object.getPrototypeOf : function(e) {
    ...
    var Hs = Object.create || function(e, t) {
        ...
        cl = function(e, t, n, i, r, a, o) {
            ...
            if (g && (s = $s(g.call(new e)), el !== Object.prototype && s.next && ($s(s) !== el && (Xs ? Xs(s, el) : "function" != typeof s[nl] && Js(s, nl, ol)), Gs(s, d, !0))), r == rl && v && v.name !== rl && (h = !0, p = function() {
                    return v.call(this)
    ...
    sh("replace", 2, (function(e, t, n, i) {
        ...
        return [function(n, i) {
            ...
            for (var p, g = "", m = 0, y = 0; y < f.length; y++) {
                v = f[y];
                for (var b = String(v[0]), w = ph(gh(uh(v.index), c.length), 0), S = [], E = 1; E < v.length; E++) S.push(void 0 === (p = v[E]) ? p : String(p));
                var k = v.groups;
                if (u) {
            ...
            return Ri(e, [{
                ...
                value: function(e) {
                    ...
                    if (!(r || a || o || u)) {
                        ...
                        var f, v, p = "linear" === t.navigationMode || !this.Reveal.hasHorizontalSlides() || !this.Reveal.hasVerticalSlides(),
                            g = !1;
                        if ("object" === Si(t.keyboard))
                            for (d in t.keyboard)
                                if (parseInt(d, 10) === n) {
                                    var m = t.keyboard[d];
                                    "function" == typeof m ? m.apply(null, [e]) : "string" == typeof m && "function" == typeof this.Reveal[m] && this.Reveal[m].call(), g = !0
                                } if (!1 === g)
                            for (d in this.bindings)
                                if (parseInt(d, 10) === n) {
                                    var y = this.bindings[d].callback;
                                    "function" == typeof y ? y.apply(null, [e]) : "string" == typeof y && "function" == typeof this.Reveal[y] && this.Reveal[y].call(), g = !0
                                }! 1 === g && (g = !0, 80 === n || 33 === n ? this.Reveal.prev() : 78 === n || 34 === n ? this.Reveal.next() : 72 === n || 37 === n ? l ? this.Reveal.slide(0) : !this.Reveal.overview.isActive() && p ? this.Reveal.prev() : this.Reveal.left() : 76 === n || 39 === n ? c ? this.Reveal.slide(Number.MAX_VALUE) : !this.Reveal.overview.isActive() && p ? this.Reveal.next() : this.Reveal.right() : 75 === n || 38 === n ? !this.Reveal.overview.isActive() && p ? this.Reveal.prev() : this.Reveal.up() : 74 === n || 40 === n ? !this.Reveal.overview.isActive() && p ? this.Reveal.next() : this.Reveal.down() : 36 === n ? this.Reveal.slide(0) : 35 === n ? this.Reveal.slide(Number.MAX_VALUE) : 32 === n ? (this.Reveal.overview.isActive() && this.Reveal.overview.deactivate(), e.shiftKey ? this.Reveal.prev() : this.Reveal.next()) : 58 === n || 59 === n || 66 === n || 86 === n || 190 === n || 191 === n ? this.Reveal.togglePause() : 70 === n ? (f = t.embedded ? this.Reveal.getViewportElement() : document.documentElement, (v = (f = f || document.documentElement).requestFullscreen || f.webkitRequestFullscreen || f.webkitRequestFullScreen || f.mozRequestFullScreen || f.msRequestFullscreen) && v.apply(f)) : 65 === n ? t.autoSlideStoppable && this.Reveal.toggleAutoSlide(i) : g = !1), g ? e.preventDefault && e.preventDefault() : 27 !== n && 79 !== n || (!1 === this.Reveal.closeOverlay() && this.Reveal.overview.toggle(), e.preventDefault && e.preventDefault()), this.Reveal.cueAutoSlide()
                    }
                }
            }]), e
        }(),
                                ...
                                return c = n.map((function(e) {
                                    ...
                                    if (!1 === e.classList.contains("stack")) {
                                        ...
                                        if (u.push(v), v.className = "pdf-page", v.style.height = (o + t.pdfPageHeightOffset) * f + "px", v.appendChild(e), e.style.left = r + "px", e.style.top = d + "px", e.style.width = s + "px", e.slideBackgroundElement && v.insertBefore(e.slideBackgroundElement, e), t.showNotes) {
                                            ...
                                            if (p) {
                                                var g = "string" == typeof t.showNotes ? t.showNotes : "inline",
                                                    m = document.createElement("div");
                                                m.classList.add("speaker-notes"), m.classList.add("speaker-notes-pdf"), m.setAttribute("data-layout", g), m.innerHTML = p, "separate-page" === g ? u.push(m) : (m.style.left = "8px", m.style.bottom = "8px", m.style.width = a - 16 + "px", v.appendChild(m))
                                            }
                                        }
                                        if (i) {
                                            var y = n + 1,
    ...
    function _f(e, t) {
        ...
        function D(n) {
            return v.wrapper = e, v.slides = e.querySelector(".slides"), l = wi(wi(wi(wi(wi({}, Uf), l), t), n), Mh()), F(), window.addEventListener("load", oe, !1), M.load(l.plugins, l.dependencies).then(z), new Promise((function(e) {
                return s.on("ready", e)
            }))
        }
        ...
        function Y() {
            window.addEventListener("resize", nt, !1), l.touch && O.bind(), l.keyboard && x.bind(), l.progress && C.bind(), l.respondToHashChanges && L.bind(), P.bind(), T.bind(), v.slides.addEventListener("transitionend", tt, !1), v.pauseOverlay.addEventListener("click", ge, !1), l.focusBodyOnPageVisibilityChange && document.addEventListener("visibilitychange", it, !1)
        }

        function $() {
            O.unbind(), T.unbind(), x.unbind(), P.unbind(), C.unbind(), L.unbind(), window.removeEventListener("resize", nt, !1), v.slides.removeEventListener("transitionend", tt, !1), v.pauseOverlay.removeEventListener("click", ge, !1)
        }
        ...
        function Se(e, t, o, s) {
            ...
            if (0 !== c.length) {
                ...
                }), !g && r || (w.stopEmbeddedContent(r), w.startEmbeddedContent(a)), requestAnimationFrame((function() {
                    _(q(a))
        ...
        function Ee() {
            $(), Y(), oe(), g = l.autoSlide, We(), k.create(), L.writeURL(), A.sortAll(), P.update(), C.update(), Le(), j.update(), j.updateVisibility(), k.update(!0), S.update(), w.formatEmbeddedContent(), !1 === l.autoPlayMedia ? w.stopEmbeddedContent(a, {
                unloadIframes: !1
        ...
        function We() {
            if (Ve(), a && !1 !== l.autoSlide) {
                ...
                t ? g = parseInt(t, 10) : i ? g = parseInt(i, 10) : n ? g = parseInt(n, 10) : (g = l.autoSlide, 0 === a.querySelectorAll(".fragment").length && kh(a, "video, audio").forEach((function(e) {
                    e.hasAttribute("data-autoplay") && g && 1e3 * e.duration / e.playbackRate > g && (g = 1e3 * e.duration / e.playbackRate + 1e3)
                }))), !g || b || ye() || R.isActive() || ve() && !A.availableRoutes().next && !0 !== l.loop || (m = setTimeout((function() {
                    "function" == typeof l.autoSlideMethod ? l.autoSlideMethod() : Ze(), We()
                }), g), y = Date.now()), o && o.setPlaying(-1 !== m)
            }
        }
        ...
        function $e() {
            u.hasNavigatedHorizontally = !0, l.rtl ? (R.isActive() || !1 === A.next()) && Pe().left && Se(n + 1, "grid" === l.navigationMode ? i : void 0) : (R.isActive() || !1 === A.prev()) && Pe().left && Se(n - 1, "grid" === l.navigationMode ? i : void 0)
        }

        function Xe() {
            u.hasNavigatedHorizontally = !0, l.rtl ? (R.isActive() || !1 === A.prev()) && Pe().right && Se(n - 1, "grid" === l.navigationMode ? i : void 0) : (R.isActive() || !1 === A.next()) && Pe().right && Se(n + 1, "grid" === l.navigationMode ? i : void 0)
        }
        ...
        function Je() {
            u.hasNavigatedVertically = !0, (R.isActive() || !1 === A.next()) && Pe().down && Se(n, i + 1)
        }
